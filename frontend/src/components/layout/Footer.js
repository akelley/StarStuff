  ...
  return (
    <footer className="footer">
      <div className="footer-left">
        <button className="btn btn-link btn-link-footer-left"><a href="https://atkelley.github.io/" target="_blank" rel="noopener noreferrer">AK-47</a></button><span> &copy; 2025</span>
      </div>
